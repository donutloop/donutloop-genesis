...
* [Clean Republic SODO, LLC (Hill Topper / Dakota Lithium)](https://www.electric-bike-kit.com/): [Hill Topper Electric Bike](https://hilltopperbikes.com/) - Seattle-based lithium battery and light electric mobility manufacturer, industry partner on the University of North Dakota-led Genesis Mission Phase I project on adversarial robustness for AI models in battery management and energy science workflows.
...
* [Deep Isolation](https://www.deepisolation.com/): [Nuclear Innovator Deep Isolation Selected by DOE for Three Project Genesis Initiatives Advancing AI-Driven Nuclear Waste Research](https://www.deepisolation.com/press/nuclear-innovator-deep-isolation-selected-by-doe-for-three-project-genesis-initiatives-advancing-ai-driven-nuclear-waste-research) - Deep borehole nuclear waste disposal innovator selected as the sole industrial partner on three Genesis Mission awards (two led by Lawrence Berkeley National Laboratory, one by the University of South Carolina), applying AI to repository site screening, fatal flaw analysis, design, and performance assessment for spent nuclear fuel and high-level radioactive waste.
...
* [Antares Nuclear (Antares Industries, Inc.)](https://www.antaresindustries.com/)
...
* [DOE: Announces New Supercomputer Powered by Dell and NVIDIA to Speed Scientific Discovery](https://www.energy.gov/articles/doe-announces-new-supercomputer-powered-dell-and-nvidia-speed-scientific-discovery)
* [NERSC: DOE Announces New Supercomputer (Doudna) Powered by Dell and NVIDIA](https://www.nersc.gov/news-and-events/news/doe-announces-new-supercomputer-powered-by-dell-and-nvidia-to-speed-scientific-discovery)
...
* [xLight: xLight Finalizes $150M CHIPS Incentives with U.S. Department of Commerce](https://www.xlight.com/blog/xlight-finalizes-150m-chips-incentives-with-u-s-department-of-commerce)
* [NIST: Department of Commerce Finalizes CHIPS Incentives Award to xLight](https://www.nist.gov/news-events/news/2026/06/department-commerce-finalizes-chips-incentives-award-xlight-inc) - dead
* [NIST: Department of Commerce Announces Letter of Intent with xLight for CHIPS Incentives](https://www.nist.gov/news-events/news/2025/12/department-commerce-announces-letter-intent-xlight-chips-incentives) - dead
...
* [Fermilab: xLight and Fermilab Cooperative Research and Development Agreement (CRADA) for Superconducting FEL Technology](https://news.fnal.gov/2024/fermilab-xlight-crada-superconducting-technology/) - dead
...
* [Arcee AI: Arcee Trinity Large Technical Report (arXiv:2602.17004)](https://arxiv.org/abs/2602.17004)
* [Arcee AI: Arcee's MergeKit — A Toolkit for Merging Large Language Models (arXiv:2403.13257)](https://arxiv.org/abs/2403.13257)
* [Arcee AI: Spectrum — Targeted Training on Signal to Noise Ratio (arXiv:2406.06623)](https://arxiv.org/abs/2406.06623)
...
* [PR Newswire Release: Domino Data Lab Joins U.S. Department of Energy's Genesis Mission Consortium to Accelerate AI-Driven Scientific Discovery](https://www.prnewswire.com/news-releases/domino-data-lab-joins-us-department-of-energys-genesis-mission-consortium-to-accelerate-ai-driven-scientific-discovery-302844353.html)
...
* [NSF: Dear Colleague Letter — Unleashing a New Age of AI-Enabled Scientific Discovery Through a Strategic Investment in Research and Research Workforce](https://www.nsf.gov/funding/opportunities/dcl-unleashing-new-age-ai-enabled-scientific-discovery-through) - NSF publication **NSF 26-023** (issued **July 22, 2026**; signed by Chief Science Officer **Simon Malcomber**) invites proposals for AI-enabled scientific discovery and foundational research in support of the Genesis Mission established under **Executive Order 14363** (*Launching the Genesis Mission*). The DCL spans three NSF interest areas: (1) *Leveraging and Building AI for Science* — autonomous/semi-autonomous laboratories (process optimization and intelligent experimentation across biology, chemistry, and materials), AI models fused with novel datasets integrating domain knowledge, mechanistic models, physical constraints, scientific literature, and reasoning for hypothesis generation, plus ambitious cross-disciplinary questions within reach of emerging AI; (2) *Building Foundations for S&T Challenges* — early-stage fundamental research advancing one or more of the Genesis National S&T Challenges (DOE's initial focused set of **26**, expanded in Summer 2026); and (3) *Growing Workforce and Capacity in AI for Science* — workforce/capacity initiatives and research fellowships with industry cost-share and hands-on training at Federal R&D facilities. PIs title proposals with the **"Genesis Mission:"** prefix; awarded projects gain access to the **National AI Research Resource (NAIRR)** and the Genesis Mission platform, advancing the **America's AI Action Plan**. Participating NSF directorates: BIO, CISE, EDU, ENG, GEO, MPS, SBE. Contact: `GenesisMissionNSF@nsf.gov`.
...
* [CoreWeave: NVIDIA Blackwell GPUs on the CoreWeave AI Cloud (GB200 / GB300 NVL72)](https://www.coreweave.com/products/nvidia-blackwell)
* [CoreWeave: SUNK — Slurm on Kubernetes Unified AI Training System](https://www.coreweave.com/products/sunk)
...
* [Domino Data Lab: Domino Nexus — Hybrid and Multicloud AI Platform](https://domino.ai/platform/nexus)
* [Domino Data Lab: Nexus Hybrid Architecture (Control Plane & Data Planes)](https://docs.dominodatalab.com/en/latest/admin_guide/c65074/nexus-hybrid-architecture/)
* [Domino Data Lab: On-Demand Distributed Computing (Spark, Ray, Dask & MPI)](https://docs.dominodatalab.com/en/latest/user_guide/8b4418/on-demand-distributed-computing/)
* [Domino Data Lab: Domino Cloud — Fully Managed AI Platform & FedRAMP High Government Enclaves](https://domino.ai/platform/cloud)
...
* [Veritone: aiWARE — Enterprise AI Operating System](https://www.veritone.com/aiware/)
* [Veritone: Data Refinery — Transform Data, Drive Intelligence](https://www.veritone.com/industries/data-asset-management/)
* [FedRAMP Marketplace: Veritone Intelligent Digital Evidence Management System (iDEMS)](https://www.fedramp.gov/marketplace/products/FR1804557312/)
...
* [DOE Office of Nuclear Energy: 8 Big Wins for Nuclear in the Trump Administration's First Year](https://www.energy.gov/ne/articles/8-big-wins-nuclear-trump-administrations-first-year)
...
* [SambaNova Systems](https://sambanova.ai/): [SambaNova Joins the DOE Genesis Mission Consortium](https://sambanova.ai/blog/sambanova-joins-the-genesis-mission-consortium) - Corporate announcement of SambaNova's membership in the public-private Genesis Mission Consortium, contributing its inference-optimized Reconfigurable Dataflow Unit (RDU) architecture—supporting models of up to 10 trillion parameters across 256 RDUs at high throughput and energy efficiency—to the DOE National S&T Challenges established under Executive Order 14363.
* [PrimaLabs](https://www.primalabs.ai/): [PrimaLabs Joins NVIDIA & DOE Genesis Mission](https://www.primalabs.ai/blog/primalabs-joins-nvidia-genesis-mission) - Corporate announcement of PrimaLabs joining NVIDIA and DOE national laboratories (Savannah River National Laboratory, Oak Ridge National Laboratory, Pacific Northwest National Laboratory) in the Genesis Mission, contributing AI performance engineering and dedicated GPU-accelerated inference infrastructure for open scientific models supporting environmental remediation and discovery science workloads.
* [Armada](https://www.armada.ai/): [Armada Agreement with the U.S. Department of Energy to Accelerate the Genesis Mission](https://www.armada.ai/blog/genesis-mission) - Corporate announcement of Armada's collaboration agreement with the U.S. Department of Energy (DOE) to accelerate the Genesis Mission, deploying sovereign, distributed AI infrastructure through its **Galleon** modular data centers and the **Armada Edge Platform**, enabling megawatt-scale GPU-rich compute to be stood up at national laboratory and field research sites in weeks to months rather than years.
* [Everstar](https://everstar.ai/): [Everstar Announces Collaboration with DOE, National Laboratories, and Microsoft, Marking Its First Major Milestone in the Genesis Mission](https://everstar.ai/news/everstar-major-milestone-in-the-genesis-mission) - First-party corporate announcement of Everstar's collaboration with the U.S. Department of Energy (DOE), Idaho National Laboratory (INL), Argonne National Laboratory (ANL), and Microsoft, in which the **Gordian AI** platform running on Microsoft Azure converted the National Reactor Innovation Center (NRIC) Generic High Temperature Gas Reactor (HTGR) preliminary documented safety analysis into a **208-page, citation-mapped NRC license application in a single day** versus 4–6 weeks for an expert team, under a "design–AI–validate" model extending to engineering drawing interpretation, INL/NVIDIA Omniverse physics simulation, and NQA-1 manufacturing compliance.
* [Cognition](https://cognition.com/): [Cognition Signs MOU with U.S. Department of Energy to Join The Genesis Mission](https://cognition.com/blog/cognition-doe-genesis-mission) - First-party corporate announcement of Cognition's memorandum of understanding (MOU) with the U.S. Department of Energy (DOE) to join the Genesis Mission, deploying its autonomous AI software engineer **Devin** across four workstreams—code and data security scanning with the **Devin Security Swarm**, modernization of legacy scientific code (Fortran, C++, COBOL), expansion of scientific workforce capacity by offloading data-pipeline, deployment, and infrastructure engineering, and cloud-native migration of legacy laboratory infrastructure—supported by in-kind security scans, remediation reports, and free compute for Genesis-funded consortia teams, with the platform progressing through FedRAMP High authorization and existing deployments across the U.S. Army, U.S. Navy, NASA JPL, and the OPM Tech Force.
* [Siemens Government Technologies (SGT)](https://www.siemensgovt.com/): [Siemens to Help Build AI-Ready Scientific Infrastructure as Part of U.S. Department of Energy's Genesis Mission](https://www.siemensgovt.com/insights/press-releases/press-genesis/) - Federal-facing announcement from Siemens' U.S. government business confirming Siemens' participation in the DOE Genesis Mission, contributing industrial AI, advanced simulation, physics-based digital twins, automation, and secure infrastructure through the **Siemens Xcelerator** portfolio as one connected technology stack rather than isolated AI point solutions, with domain-specific AI embedded directly into engineering, validation, and operational workflows so that simulation, testing, validation, and deployment remain continuously aligned from research to real-world scale-up across energy, manufacturing, and mission-critical infrastructure.
* [Windows Forum News](https://windowsforum.com/): [DOE Genesis Mission: Turning AI Into Infrastructure for U.S. Scientific Discovery](https://windowsforum.com/windows-news.4/doe-genesis-mission-turning-ai-into-infrastructure-for-u-s-scientific-discovery.420866/) - Analytical technology-press assessment framing the Genesis Mission as an effort to make AI a permanent layer of national research infrastructure — as foundational as the electrical grid or internet connectivity — rather than a portfolio of stand-alone tools or demonstration pilots, describing the **American Science and Security Platform** as the connective tissue binding the 17 DOE National Laboratories, their supercomputers, curated scientific data stores, and experimental user facilities into one closed-loop environment for experiment design, automation, analysis, and prediction, and reiterating the decade-long goal of doubling the productivity and impact of American research across the three national challenge areas of energy dominance, discovery science, and national security, supported by the **American Science Cloud (AmSC)** model/data distribution layer and the **Transformational AI Models Consortium (ModCon)**, with the initiative compared in scale and ambition to the Manhattan Project and the Apollo Moon landing.
* [Everstar](https://everstar.ai/): [Gordian — High-Consequence Decisions at Machine Speed](https://everstar.ai/gordian) - First-party product page for the **Gordian** nuclear AI platform, documenting semantic ontology mapping of the regulatory corpus and physics-grounded reasoning for license application drafting, and its deployment posture — Microsoft Azure certified hosting, SOC 2 controls, FedRAMP-track authorization, optional on-premises installation, and conformance with U.S. nuclear export control rules (10 CFR 810).
* [DOE Office of Nuclear Energy](https://www.energy.gov/ne/office-nuclear-energy): [Department of Energy Unleashes AI to Reduce Reactor Licensing Timelines](https://www.energy.gov/ne/articles/department-energy-unleashes-ai-reduce-reactor-licensing-timelines) - Federal account of the DOE / INL / ANL / Microsoft / Everstar collaboration converting the National Reactor Innovation Center (NRIC) Generic High Temperature Gas Reactor (HTGR) preliminary documented safety analysis into a structured NRC license application in a single day.
* [Rescale](https://rescale.com/): [Rescale Awarded Funding Under the US Department of Energy's Genesis Mission for Agentic Digital Engineering](https://rescale.com/news/rescale-awarded-funding-us-department-energy-genesis-mission-agentic-digital-engineering) - First-party corporate announcement of Rescale's Genesis Mission award as the only commercial technology company in the **Agentic HPC Pipeline Initiative (AHPI)** consortium with Lawrence Berkeley, Lawrence Livermore and Oak Ridge National Laboratories, applying agentic AI to the **WarpX**, **LiDO** and **Adamantine** simulation codes to reduce the engineering expertise and time required for national laboratory simulation by more than fivefold.
* [Rescale: Intelligent Computing Platform — HPC & AI Architectures](https://rescale.com/platform/hpc-ai-architectures/)
* [Rescale: Compute Recommendation Engine (CRE)](https://rescale.com/glossary/compute-recommendation-engine-cre/)
* [Rescale: Introducing Rescale Data Intelligence — Unified Data Fabric & Digital Thread for Simulation](https://rescale.com/blog/introducing-rescale-data-intelligence/)
* [Rescale: AI Physics Operating System — Surrogate Model Training, Validation & Inference](https://rescale.com/platform/ai-physics/)
* [Rescale: Receives Success Memorandum from the Defense Innovation Unit for its HPC Modernization Program](https://rescale.com/news/rescale-receives-success-memorandum-from-the-defense-innovation-unit-for-its-hpc-modernization-program/)
...
* [Antares Nuclear](https://www.antaresindustries.com/): [Department of Energy Celebrates First Advanced Reactor Criticality](https://www.energy.gov/articles/department-energy-celebrates-first-advanced-reactor-criticality) - DOE announcement of the **Mark-0** zero-power criticality on **June 4, 2026** at Idaho National Laboratory — the first advanced reactor to achieve criticality under the **Reactor Pilot Program**, the first privately developed non-light-water reactor to go critical in the United States in more than four decades, and the first novel reactor at INL in over 50 years.
* [U.S. Department of Energy Reactor Pilot Program](https://www.energy.gov/ne/us-department-energy-reactor-pilot-program) - DOE Office of Nuclear Energy programme page for the reactor authorization pathway created under Executive Order 14301 (May 2025), targeting at least three privately funded advanced reactor criticalities by July 4, 2026 outside the NRC licensing process, with DOE-approved safety analyses and HALEU fuel allocations for the selected developers (Antares Nuclear, Valar Atomics, Deployable Energy, Radiant and others).
* [Antares: Antares Achieves Initial Criticality of a Privately Developed Advanced Reactor Under DOE Pilot Program](https://www.businesswire.com/news/home/20260604167405/en/Antares-Achieves-Initial-Criticality-of-a-Privately-Developed-Advanced-Reactor-Under-DOE-Pilot-Program) - First-party announcement describing the sodium heat-pipe-cooled, HALEU TRISO-fuelled **Mark-0** microreactor, its DOE-approved Preliminary Documented Safety Analysis, the full-scale core physics, reactivity control and instrumentation validation performed at zero power, and the path to electricity generation with the **Mark-1** production unit.
* [Antares: Updates](https://antaresindustries.com/updates) - Company update index covering the $470 Million Series C (July 27, 2026; $370 Million equity and $100 Million debt co-led by Paradigm and Caffeinated Capital, taking total funding above $600 Million), the factory-produced microreactor product line and defense, space and edge-compute deployment targets from 2028.
...
* [Clean Republic SODO, LLC](https://www.electric-bike-kit.com/): [UND Selected for Inaugural U.S. Department of Energy Genesis Mission Project](https://blogs.und.edu/press-releases/2026/07/und-selected-for-inaugural-u-s-department-of-energy-genesis-mission-project/) - University of North Dakota announcement of the nine-month Phase I Genesis Mission project *Adversarial Robustness Framework for AI Models in Battery Management and Energy Science Workflows*, led by UND Assistant Professor Jielun Zhang with co-investigator Jueming Hu, collaborators Feng Ye (University of Wisconsin–Madison) and Fuhao Li (La Sierra University), and Seattle-based lithium battery manufacturer Clean Republic SODO, LLC as industry partner; the only inaugural-cohort award led from North Dakota.
* [U.S. Department of Energy: Selects 11 Projects to Advance Domestic Manufacturing of Next-Generation Batteries](https://www.energy.gov/articles/us-department-energy-selects-11-projects-advance-domestic-manufacturing-next-generation) - December 2024 selection of eleven projects under the $25 Million *Platform Technologies for Transformative Battery Manufacturing* program, including a $2 Million award to Clean Republic SODO, LLC (Dakota Lithium Materials) with Boise State University and Savannah River National Laboratory for dry-process sodium iron phosphate cathode manufacturing.
* [Micron: U.S. Expansion](https://www.micron.com/us-expansion) - Company program page for Micron's announced ~$200 Billion U.S. investment (~$150 Billion in memory manufacturing and ~$50 Billion in R&D) across the Boise, Idaho leading-edge fabs and R&D campus, the Clay, New York megafab complex, the Manassas, Virginia fab modernization, and the first U.S. advanced packaging facility for high-bandwidth memory (HBM).
* [Micron: In High-Volume Production of HBM4 Designed for NVIDIA Vera Rubin, PCIe Gen6 SSD and SOCAMM2](https://micron.gcs-web.com/news-releases/news-release-details/micron-high-volume-production-hbm4-designed-nvidia-vera-rubin) - Product announcement covering HBM4 36GB 12-high stacks (>2.8 TB/s per stack over a 2048-bit interface at >11 Gb/s pin speeds, ~2.3× HBM3E bandwidth with >20% better power efficiency), 192GB SOCAMM2 LPDDR5X server modules (up to 1.2 TB/s per CPU) and the Micron 9650 PCIe Gen6 enterprise SSD for AI and HPC data-center nodes.
* [Micron: Virginia — Manassas Fab Expansion and 1α DRAM Onshoring](https://www.micron.com/us-expansion/va) - Site page for the $275 Million CHIPS and Science Act award supporting modernization and expansion of the Manassas, Virginia facility — the only U.S.-owned 300mm memory fab — and the onshoring of 1α (1-alpha) DRAM production for automotive, aerospace, defense and industrial markets.
...
* **Berkeley Lab (LBNL):** 
  ...
  * [LBNL ATAP: Fusion, AI, and the Genesis Mission](https://atap.lbl.gov/research/crosscutting-endeavors/fusion-energy-science/fusion-ai-and-the-genesis-mission/)
...
* **Carnegie Mellon University:**
  ...
  * [What Makes Up The Universe? AI Will Help CMU Scientists Find Out (Dietrich College AI News)](https://www.cmu.edu/dietrich/ai/news/doe-genesis-grant-chad-schafer.html)
...
* **University of Colorado Boulder:**
  ...
  * [Harnessing abundant electricity from the sun, and other CU Boulder science tapped for Genesis Mission](https://www.colorado.edu/today/2026/07/22/harnessing-abundant-electricity-sun-and-other-cu-boulder-science-tapped-genesis-mission) - CU Boulder selected for six DOE Genesis Mission grants totaling over $2.4 million (lead institution on three and collaborating partner on three), spanning AI-driven real-time control of fusion plasma, quantum-computing approaches to simulate fusion plasma, ultra-fast AI for discovering new fundamental particles, an agentic AI framework for hyperlocal water and flood prediction, AI-driven extraction of quark-gluon plasma physics from high-energy nuclear collisions, and a massive AI foundation model for U.S. experimental nuclear physics research.
...
* **University of Connecticut (UConn):**
  * [Researchers Win Inaugural DOE Genesis Mission Award](https://today.uconn.edu/2026/07/uconn-researchers-win-inaugural-doe-genesis-mission-award/)
  * [Civil & Environmental Engineering: UConn Team Selected for Inaugural DOE Genesis Mission Award to Advance AI-Driven Environmental Research](https://cee.engr.uconn.edu/uconn-team-selected-for-inaugural-doe-genesis-mission-award-to-advance-ai-driven-environmental-research/)
...
* **University of Washington:**
  ...
  * [UW News: Hossein Naghavi Uses Terahertz Waves to Bring Superhuman Vision to Augmented Reality](https://www.washington.edu/news/2026/08/18/hossein-naghavi-terahertz-waves-augmented-reality-genesis-mission/) - University-wide UW News coverage of the Genesis Mission project *Neuromorphic Terahertz Imaging via Analog Compute-in-Memory in AI-Driven Augmented Reality Hardware*, led by ECE Assistant Professor Hossein Naghavi (Terahertz Integrated MicroElectronics — TIME — Lab); the effort targets low-power, high-bandwidth AR headsets that combine terahertz imaging with analog compute-in-memory AI hardware to see through smoke, fog, debris and other non-conductive obscurants, with applications spanning firefighting and emergency response, autonomous navigation, security screening, industrial inspection, biomedical sensing and beyond-5G communications.
...
* **The Ohio State University:**
  * [Ohio State Researchers to Lead National Teams Exploring Science, AI Innovation](https://news.osu.edu/ohio-state-researchers-to-lead-national-teams-exploring-science-ai-innovation/)
  * [College of Engineering / CSE Coverage: Ohio State Researchers to Lead National Teams Exploring Science, AI Innovation](https://cse.osu.edu/news/2026/07/ohio-state-researchers-lead-national-teams-exploring-science-ai-innovation) - Departmental coverage of the two Ohio State-led Genesis Mission Phase I teams: *AI for Orbital Electronics Materials and Manufacturing* (Prof. Roland Kawakami, Physics, with USC, Yale, Argonne National Laboratory and Intel) and **ROBIN-NET** — *RObust BIdirectional PINNs for Accelerated Complex Flow Modeling and Discovery* (Prof. Han-Wei Shen, Computer Science and Engineering, with Los Alamos National Laboratory, Oak Ridge National Laboratory and NVIDIA); each team is funded at $500,000–$750,000 over nine months with eligibility to compete for follow-on Phase II funding of up to $15 Million over three years.
...
* **University of Wisconsin–Madison:**
  ...
  * [Ye Is Part of Genesis Mission to Protect AI From Cyber Threats](https://engineering.wisc.edu/blog/ye-is-part-of-genesis-mission-to-protect-ai-from-cyber-threats/)
* **Virginia Tech:**
...
* **Duke University (Pratt School of Engineering):** [DOE Funds Duke-Led AI Platform to Design Transformative DNA-Based Materials](https://pratt.duke.edu/news/doe-genesis-program-dna-origami/) - Gaurav Arya, professor in the Thomas Lord Department of Mechanical Engineering and Materials Science, received a Phase 1 Genesis Mission grant to build an AI platform for the inverse design of DNA origami building blocks that self-assemble into large, hierarchically ordered lattices; the work targets the gap between individual origami structures (typically under 100 nanometers) and programmable periodic architectures spanning tens of micrometers, with computational frameworks that automate the design search for photonic, electronic and catalytic biomolecular materials.
* **Duke University (Pratt School of Engineering):** [DOE-Funded Brain-Inspired Hardware to Enable Futuristic Robotic Systems](https://pratt.duke.edu/news/doe-funded-brain-inspired-hardware-to-enable-futuristic-robotic-systems/) - Yiran Chen (John Cocke Distinguished Professor of Electrical and Computer Engineering) leads a Phase 1 Genesis Mission project with Tania Roy (Duke), Shimeng Yu (Georgia Tech) and Wei Xu (Brookhaven National Laboratory) to build neuromorphic, brain-inspired hardware for robotics targeting 10× faster and 100× more energy-efficient AI processing than the state of the art; the work addresses the datacenter-GPU dependence of vision-language-action (VLA) models with up to 55 billion parameters by moving perception, reasoning and actuation on-device for real-time, mobile robotic autonomy.
* **University of Chicago:** [Argonne Marks 80 Years of Scientific Discovery](https://news.uchicago.edu/story/argonne-marks-80-years-scientific-discovery) - University of Chicago newsroom feature marking the 80th anniversary (chartered 1 July 1946) of Argonne National Laboratory, which the university operates for the DOE through UChicago Argonne, LLC; recounts the lab's origins in the Manhattan Project and peaceful atomic power research, the Experimental Breeder Reactor-I (EBR-I) demonstration of the world's first usable electricity from nuclear energy, and the modern portfolio spanning the Aurora exascale supercomputer, the Q-NEXT quantum information science hub (renewed for a further five years), a world-record electron beam emittance at the upgraded Advanced Photon Source, energy storage, advanced manufacturing and materials science; DOE user facilities serve nearly 8,000 researchers annually, and the anniversary program included the *Beyond the Reactor* OutLoud public lecture, an AI Roadshow community series, and a 27 June 2026 open house drawing more than 8,000 visitors, with the forward agenda centered on embedding AI into scientific discovery under the DOE Genesis Mission alongside quantum information science, microelectronics and next-generation nuclear reactors.
* **University of Chicago:** [Department of Energy Extends Contract with UChicago Argonne, LLC](https://news.uchicago.edu/story/department-energy-extends-contract-uchicago-argonne-llc) - Announcement (14 July 2026) that the Department of Energy extended its management and operating contract with UChicago Argonne, LLC — the limited liability company wholly owned by the University of Chicago that has operated Argonne National Laboratory under prime contract DE-AC02-06CH11357 since 1 October 2006 — for an additional five-year term covering 1 October 2026 through 30 September 2031; the university president chairs the LLC Board of Governors, and the laboratory's annual operating budget exceeds $1 billion against roughly $17.3 billion in cumulative contract obligations.
* **University of Chicago (Pritzker School of Molecular Engineering):** [Department of Energy Selects UChicago/URA-Led Fermi Forward Discovery Group to Operate Fermilab](https://pme.uchicago.edu/news-events/news/department-energy-selects-uchicago-ura-led-fermi-forward-discovery-group-operate) - Announcement that DOE selected Fermi Forward Discovery Group, LLC (FermiForward) — led by the University of Chicago with the Universities Research Association, Amentum Environment & Energy and Longenecker & Associates — as the management and operating contractor for Fermi National Accelerator Laboratory, with the contract beginning 1 January 2025 for an initial five-year term extendable to fifteen years, succeeding the Fermi Research Alliance, LLC (University of Chicago and URA) that had operated the laboratory since 2007.
* **University of Chicago (Polsky Center for Entrepreneurship and Innovation):** [The University of Chicago Partners with IBM to Strengthen Quantum Computing Startups in Illinois](https://polsky.uchicago.edu/2025/07/24/the-university-of-chicago-partners-with-ibm-to-strengthen-quantum-computing-startups-in-illinois/) - Description of the UChicago–IBM partnership extending startups in the Duality accelerator — the nation's first quantum-focused accelerator, launched in April 2021 by the Polsky Center and the Chicago Quantum Exchange with the University of Illinois Urbana-Champaign, Argonne National Laboratory and P33 — access to IBM quantum hardware, including an IBM Quantum System Two and a National Quantum Algorithm Center planned for the Illinois Quantum and Microelectronics Park (IQMP).
* **Chicago Quantum Exchange (CQE):** [Chicago Quantum Exchange](https://chicagoquantum.org/) - Hub for quantum information science founded in 2017 at the University of Chicago's Pritzker School of Molecular Engineering, anchored by Argonne National Laboratory, Fermilab, the University of Illinois Urbana-Champaign, the University of Wisconsin–Madison, Northwestern University and Purdue University, with more than twenty corporate partners; the exchange coordinates regional quantum research, workforce development and the Illinois Quantum and Microelectronics Park (IQMP) ecosystem.
* **Q-NEXT (Argonne-Led National QIS Research Center):** [Argonne-Led Q-NEXT Quantum Center Renewed for Five Years](https://www.anl.gov/article/argonneled-qnext-quantum-center-renewed-for-five-years) - Announcement (4 November 2025, Chicago Quantum Summit) that DOE renewed the Argonne-led Q-NEXT National Quantum Information Science Research Center for a further five years at $125 million, part of a $625 million renewal across all five DOE QIS centers; Q-NEXT spans two national laboratories, eleven universities including the University of Chicago, and six technology companies, operating national quantum foundries at Argonne and SLAC with a new emphasis on distributed entanglement and integrated quantum–classical networks.
* **University of Chicago (Data Science Institute):** [AI+Science Research Initiative](https://datascience.uchicago.edu/research/ai-science/) - Research initiative of the University of Chicago Data Science Institute bridging machine learning methodology with the physical and biological sciences, coordinating the AI+Science summer school, hackathons and the Eric and Wendy Schmidt AI in Science Postdoctoral Fellowship cohorts that feed AI methods into Argonne and Fermilab scientific workflows.
* **The Catholic University of America (CUA):** [Catholic University Researchers Earn Funding and Awards for AI-Related Research](https://www.catholic.edu/all-stories/catholic-university-researchers-earn-funding-and-awards-ai-related-research) - University newsroom round-up of AI research funding and awards in the College of Engineering, Physics, and Computing: a **$300,000** DOE Genesis Mission award for *AI-Driven Expedited Discovery and Background Separation for Petabyte-Scale Streaming Readout*, led by nuclear physics professor **Tanja Horn** with **Dominick Rizk** (Computer Science) and **Dmitry Romanov** (Jefferson Lab), embedding physics-aware AI directly into streaming-readout detector data at the Electron-Ion Collider (EIC) to separate rare physics signals from background in real time; a **$750,000** National Science Foundation award for *Studies of Pion and Kaon Structure and AI to Expedite Science Output*, applying AI/ML to experimental nuclear physics data analysis and student training; plus faculty and student awards for applied AI work spanning healthcare risk assessment frameworks and deep-learning medical image segmentation.
