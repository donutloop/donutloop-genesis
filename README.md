...
* **U.S. Department of Energy (DOE) — Office of Science & CMEI:** Leads overall mission execution, funding solicitations (DE-FOA-0003612), exascale computing facility orchestration, and national lab hub operations. Through the official DOE *Artificial Intelligence Topics & Initiatives* portal (`www.energy.gov/topics/artificial-intelligence`), the DOE manages a multi-faceted AI portfolio encompassing the **Genesis Mission**, **VoltAIc** and **PermitAI** (automated environmental licensing), **ChatGrid** (generative AI power grid control), **AI4Fusion**, and **ModCon**, integrating the 17 National Laboratories and 32 user facilities into the **American Science and Security Platform**.
