...
* **U.S. Department of Health and Human Services (HHS) & NIH:** Directs biomedical AI initiatives under its official announcement (*HHS Joins Genesis Mission to Harness AI for Chronic Disease Research*, `www.hhs.gov/press-room/hhs-joins-genesis-mission-ai-chronic-disease-research.html`), unifying NIH, CDC, FDA, and ARPA-H under the "Make America Healthy Again" (MAHA) research framework. HHS launches flagship National S&T Challenges targeting the root causes of chronic disease (obesity, diabetes, cardiovascular illness, neurodegeneration) and pediatric oncology, while NIH leads the **Bio Genesis Mission** deploying multimodal foundation models and automated structural biology pipelines integrated into the **American Science and Security Platform**.
