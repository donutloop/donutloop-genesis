...
- **Coverage Matrix Update**: Added **University of Nevada, Las Vegas (UNLV)** (#166) to `coverage.md` under *Research Universities* with status `✅ Full Profile`; updated university and overall profile totals to **68** and **188**, respectively.
