...
* **U.S. Department of Energy (DOE) — Office of Science & CMEI:** Leitet die Gesamtausführung der Mission, Finanzierungsaufforderungen (DE-FOA-0003612), die Orchestrierung von Exascale-Rechenanlagen und den Betrieb der nationalen Labor-Hubs. Geleitet von der Richtlinie des Staatssekretärs für Wissenschaft Dr. Darío Gil (*Letter to the Community*, `www.energy.gov/science/articles/under-secretary-gils-letter-community`), dem offiziellen Plattform-Überblick (`www.energy.gov/undersecretaryforscience/genesis-mission/genesis-mission`), der Kooperationsrichtlinie (`www.energy.gov/undersecretaryforscience/genesis-mission/genesis-mission-collaboration`) und dem technischen Herausforderungsbericht (*Genesis Mission: National Science & Technology Challenges* PDF, `www.energy.gov/documents/genesis-mission-national-science-technology-challenges`) definiert das DOE technische Problemformulierungen, rechnerische Baselines und Evaluierungsmatrizen für 33 hochkarätige wissenschaftliche Herausforderungen in den Bereichen Energiedominanz, Entdeckungswissenschaft und nationale Sicherheit. Das DOE orchestriert das **Genesis Mission Consortium** – sichert über **800 Millionen US-Dollar** an zugesagter Partnerunterstützung und startet die **Genesis Open Models Initiative** (Open-Weight wissenschaftliche LLMs wie *Genesis-Science-1*). Das DOE baut ein **"Internet der Wissenschaft"** auf – eine föderierte Entdeckungs-Engine im geschlossenen Regelkreis, die Exascale-HPC-Supercomputer, 7-Modalitäten-QPUs und KI-Basismodelle über 17 Nationale Laboratorien, 5 NNSA-Standorte, 32 Nutzeranlagen, 57+ Forschungsuniversitäten und Industrie-Hyperscaler in der **American Science and Security Platform** vereint. Das Portfolio umfasst zudem **VoltAIc**, **PermitAI**, **ChatGrid**, **AI4Fusion** und **ModCon**.
...
* **National Science Foundation (NSF):** Stellt **83 Millionen US-Dollar** über das Programm **Integrated Data Systems and Services (IDSS)** und die Förderinitiative *"Unlocking Dataset Value for AI-Enabled Scientific Discovery"* (**AI Datasets**-Programm) bereit. Die Initiative baut ein interoperables wissenschaftliches Datenrückgrat auf, das automatisierte Merkmalsextraktion, KI-Metadaten-Generierung und FAIR-Datenpipelines entwickelt, um KI-Basismodelle über die National Artificial Intelligence Research Resource (NAIRR), akademische MINT-Labore und die **American Science and Security Platform** zu speisen.
