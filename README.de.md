...
* **U.S. Department of Energy (DOE) — Office of Science & CMEI:** Leitet die Gesamtausführung der Mission, Finanzierungsaufforderungen (DE-FOA-0003612), die Orchestrierung von Exascale-Rechenanlagen und den Betrieb der nationalen Labor-Hubs. Über das offizielle DOE-Portal *Artificial Intelligence Topics & Initiatives* (`www.energy.gov/topics/artificial-intelligence`) verwaltet das DOE ein vielseitiges KI-Portfolio, das die **Genesis-Mission**, **VoltAIc** und **PermitAI** (automatisierte Umwelt-Genehmigungsverfahren), **ChatGrid** (generative KI-Stromnetzsteuerung), **AI4Fusion** und **ModCon** umfasst und die 17 Nationalen Laboratorien sowie 32 Nutzeranlagen in die **American Science and Security Platform** integriert.
