...
* **Appendix Table:** Verify the reprocessed entity's contributions match the latest reprocessed scope in the appropriate appendix table — industry/hardware entities under `### A.3 Industry & Technology Partners`; national laboratories and universities/academic entities under their corresponding appendix tables, if present.
