# PsiQuantum — Umfassende technische Architektur, Silicon Photonic QPUs, and Ecosystem Reference Index
...
## 1. Management-Zusammenfassung & Photonic Technology Roadmap
...
## 6. Vollständiger chronologischer Presse- und Referenzindex (16 Complete Newsroom Archive Links)
...
| **2023-01-30** | [PsiQuantum Announces Breakthrough in Architectures for Error-Corrected Quantum Computing](https://www.psiquantum.com/news-import/psiquantum-announces-breakthrough-in-architectures-for-error-corrected-quantum-computing) | Hardware Architecture | Release of Active Volume Architecture reducing physical qubit and optical hardware overhead by orders of magnitude. |
